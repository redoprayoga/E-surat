    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">JL Abdul Muis, No. 38, Kampung Baru · 0815-1458-6903</span>';
            ...
            <div id="lead">
                <p>Manager</p>
                <div style="height: 50px;"></div>';
                $query = mysqli_query($config, "SELECT kepalatoko, nip FROM tbl_instansi");
                list($kepalatoko,$nip) = mysqli_fetch_array($query);
                if(!empty($kepalatoko)){
                    echo '<p class="lead">'.$kepalatoko.'</p>';
                } else {
                    echo '<p class="lead">Ferry</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP. '.$nip.'</p>';
                } else {
